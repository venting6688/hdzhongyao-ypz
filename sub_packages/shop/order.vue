<template>
  <view class="order-page">
    ...
    <view class="segmented-wrapper">
      <uni-segmented-control :current="current" :values="tabs" styleType="text" activeColor="#A77D50"
  ...
  export default {
    ...
    methods: {
      ...
      async getOrderList() {
        ...
        if (res.errno == 0 && res.data && 'orders' in res.data && res.data.orders.length > 0) {
