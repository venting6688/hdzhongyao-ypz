  ...
  data() {
    return {
      ...
      gridList: [
        [
          {
            img: '../../static/img/navigation/yuyue.png',
            name: '预约挂号',
            url: '/sub_packages/subscribe/departments'
          },
          {
            img: '../../static/img/navigation/pay.png',
            name: '门诊缴费',
            url: '/sub_packages/outpatientExpenditure/index'
          },
          {
            img: '../../static/img/navigation/report.png',
            name: '门诊报告',
            url: '/sub_packages/report/index'
          },
          {
            img: '../../static/img/navigation/jiuzhen.png',
            name: '就诊记录',
            url: '/sub_packages/record/index'
          }
        ],
        [
          // { img: '../../static/img/navigation/dengji.png', name: '入院登记', url: '/sub_packages/beHospitalizedRegister/index'},
          {
            img: '../../static/img/navigation/yujiaojin.png',
            name: '住院预交金',
            url: '/sub_packages/deposit/index'
          },
          {
            img: '../../static/img/navigation/feiyong.png',
            name: '住院费用',
        ...
        [
          ...
          {
            img: '../../static/img/navigation/tousu.png',
            name: '投诉与建议',
            url: '/sub_packages/complaint/index'
          },
          {
            img: '../../static/img/navigation/manyidu.png',
            name: '满意度调查',
            url: '/sub_packages/questionnaire/index'
          }
        ]
      ]
    }
